...
function RouteComponent() {
    return (
        <div className="mx-auto w-full max-w-screen-lg 2xl:max-w-screen-xl pt-8 px-2 space-y-4">
            <div className="grid gap-2 grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(90px,1fr))] md:grid-flow-row-dense mx-auto">
                <div className="card flex-1 flex flex-col gap-1 h-fit col-span-full xl:col-span-6 2xl:col-span-8 w-full">
                    ...
                    <p className="text-secondary">
                        Code raiding is the age-old process of endlessly trying codes on your
                        enemies base until you find one that works.
                    </p>
                    <h2 className="text-accent pt-4">How-to Code Raid:</h2>
                    <p className="text-secondary">Code raiding generally involves three steps:</p>
                    <ul>
                        <li>- Place bags</li>
                        <li>- Try codes</li>
                        <li>- Profit</li>
                    ...
                    <p className="text-secondary">
                        Use this site to coordinate with ur group. And profit efficiently.
                    </p>
                </div>
            ...
            <div className="w-full flex items-center justify-center text-secondary gap-4 text-sm">
                ...
                <a
                    href="https://github.com/v3xlabs/code-fishing"
...
export const PartyJoinButton = () => {
    ...
    return (
        <div className="flex gap-2 w-full flex-wrap">
            ...
            />
            <button className="button grow h-full" onClick={handleJoin} disabled={!validInput}>
