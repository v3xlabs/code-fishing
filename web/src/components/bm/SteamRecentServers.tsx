            ...
            <div className="flex flex-col gap-2">
                {servers.servers.slice(0, 3).map((server) => (
                    <div key={server.bm_id} className="flex gap-2 p-1 flex-col bg-[#1C221B]">
                                    ...
                                    <div className="space-y-4 max-w-md">
                                        ...
                                        <div className="grid grid-cols-1 gap-2 text-sm text-roboto">
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className={`ml-2 px-1.5 py-0.5 rounded text-xs ${server.status === 'online' ? 'bg-green-700' : 'bg-red-700'}`}>
                        ...
                        <div className="flex gap-2 items-center text-roboto">
                        ...
                        {
                            server.last_seen && (
                                <div className="text-roboto text-secondary text-end">
