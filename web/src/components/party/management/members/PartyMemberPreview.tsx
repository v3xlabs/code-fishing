            ...
            <Modal size="wide">
                <div className="w-full space-y-4">
                    ...
                    <div className="bg-tertiary p-6 flex items-center gap-4 border-b border-neutral-700">
                        ...
                        <div>
                            <a
                                href={`https://steamcommunity.com/profiles/${member.user_id.replace('steam:', '')}`}
                                target="_blank"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <div className="bg-tertiary rounded p-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-2 text-xs text-secondary mt-2">
                                                <div>
                                                    Bullets Hit: {stats.pvp_stats.bullets_hit}
                                                </div>
                                                <div>
                                        ...
                                        <div className="bg-tertiary rounded p-3">
                                            ...
                                            <div className="w-full bg-primarybg rounded-full h-2 mb-1">
                                                <div
                                                    className="bg-rust h-2 rounded-full"
                                                    style={{
                                                        width: `${deathPercentages.suicide}%`,
                                                    }}
                                                ></div>
                                            </div>
                                            <div className="text-xs text-secondary text-center">
                                        ...
                                        <div className="bg-tertiary rounded p-3">
                                            ...
                                            <div className="text-xs text-secondary text-center">
                                                ...
                                                {parseInt(stats.deaths.total.replace(/,/g, '')) -
                                                    ...
                                                    parseInt(
                                                        stats.deaths.suicide.replace(/,/g, '')
                                                    ) -
                                                    parseInt(
                                                        stats.deaths.self_inflicted.replace(
                                                            /,/g,
                                                            ''
                                                        )
                                                    )}
                                    ...
                                    <div className="card no-padding">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <StatItem
                                                ...
                                                value={
                                                    stats.horse_distance_ridden.kilometers || '0'
                                                }
                                            />
                                        </div>
                                    </div>
...
const StatItem: FC<{ icon: React.ReactNode; label: string; value: string | number }> = ({
    icon,
    label,
    value,
}) => (
...
const KillStatItem: FC<{ icon: React.ReactNode; label: string; value: string | number }> = ({
    icon,
    label,
    value,
}) => (
