                    ...
                    {(codesList?.description || codesList?.source) && (
                        <Tooltip>
                            <div className="flex flex-col gap-1">
                                {codesList?.description && <p>{codesList.description}</p>}
                                {codesList?.source && (
                                    <p>
                                        Source:{' '}
                                        <a
                                            href={codesList.source}
                                            target="_blank"
    ...
    const handleReverseToggle = (name: string) => {
        update((items) => {
            return items.map((item) =>
                item.name === name ? { ...item, reverse: !item.reverse } : item
            );
        });
    };
            ...
            <div className="card space-y-2 p-4 h-auto w-full text 3xl:col-span-2">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Tooltip>
                            <p>Customize the order of codes you want to use.</p>
